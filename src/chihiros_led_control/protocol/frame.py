"""Generic Chihiros command framing primitives.

This module deliberately knows nothing about a device family.  Family codecs
supply command ids and payloads, while this module owns the common wire frame,
checksum, timestamp, and message-id rules.
"""
